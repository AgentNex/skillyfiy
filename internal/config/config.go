...
func ParseFlags() (*Config, bool) {
	...
	flag.Usage = func() {
		...
		fmt.Printf("  v                    Turn Multi-Select mode ON / OFF\n")
		fmt.Printf("  s                    Pin span start anchor; scroll; press 's' to lock span\n")
		fmt.Printf("  Ctrl+A               Toggle select/deselect all visible items\n")
		...
		fmt.Printf("  /                    Focus search bar (press '/' again to exit)\n")
		fmt.Printf("  i / ?                Toggle keybindings help modal overlay\n")
